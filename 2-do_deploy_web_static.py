...
def do_deploy(archive_path):
    ...
    try:
        ...
        run('tar -xzf /tmp/{} -C /data/web_static/releases/{}/'.format(archive, archive_name))
        run('rm /tmp/{}'.format(archive))
        run('mv /data/web_static/releases/{0}/web_static/* /data/web_static/releases/{0}/'.format(archive_name))
